...
macro(configure_redscript REDSCRIPT_DIR)
  ...
  list(APPEND MOD_UNINSTALL_LOCATIONS "${MOD_GAME_DIR_REDSCRIPT_DIR}")
  ...
  if(EXISTS "${REDSCRIPT_MODULE_IN_FILE}")
    ...
    list(APPEND MOD_GAME_DIR_FILES ${MOD_GAME_DIR_REDSCRIPT_MODULE_FILE})
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -D COMMENT_SLUG="//" -D GLOB_EXT="reds" -D HEADER_FILE="${MOD_HEADER_TXT_FILE}" -D PACKED_FILE=${MOD_GAME_DIR_REDSCRIPT_PACKED_FILE} -D SEARCH_FOLDER=${MOD_REDSCRIPT_DIR} -P ${MOD_CYBERPUNK_CMAKE_MODULE_PATH}/PackFiles.cmake

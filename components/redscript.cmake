...
macro(configure_redscript REDSCRIPT_DIR)
  ...
  list(APPEND ${MOD_SLUG}_UNINSTALL_LOCATIONS "${MOD_GAME_DIR_REDSCRIPT_DIR}")
  ...
  if(EXISTS "${REDSCRIPT_MODULE_IN_FILE}")
    configure_file("${REDSCRIPT_MODULE_IN_FILE}" "${MOD_GAME_DIR_REDSCRIPT_MODULE_FILE}" @ONLY)
    add_custom_target(${MOD_SLUG}_redscript_module
      DEPENDS ${MOD_GAME_DIR_REDSCRIPT_MODULE_FILE}
    ...
    list(APPEND ${MOD_SLUG}_GAME_DIR_FILES ${MOD_GAME_DIR_REDSCRIPT_MODULE_FILE})
  endif()
  ...
  add_custom_command(
    ...
    BYPRODUCTS ${MOD_GAME_DIR_REDSCRIPT_PACKED_FILE}
    DEPENDS ${MOD_SLUG}_redscript_lint ${REDSCRIPT_SOURCE_FILES}
    COMMAND ${CMAKE_COMMAND} -D COMMENT_SLUG="//" -D GLOB_EXT="reds" -D HEADER_FILE="${MOD_HEADER_TXT_FILE}" -D PACKED_FILE=${MOD_GAME_DIR_REDSCRIPT_PACKED_FILE} -D SEARCH_FOLDER=${MOD_REDSCRIPT_DIR} -P ${CYBERPUNK_CMAKE_SCRIPTS}/PackFiles.cmake
  ...
  list(APPEND ${MOD_SLUG}_GAME_DIR_FILES ${MOD_GAME_DIR_REDSCRIPT_PACKED_FILE})
  list(APPEND ${MOD_SLUG}_GAME_DIR_FOLDERS ${MOD_GAME_DIR_REDSCRIPT_DIR}/${MOD_SLUG})
endmacro()

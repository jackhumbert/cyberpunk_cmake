...
macro(configure_tweaks TWEAKS_SOURCE_DIR)
  ...
  add_custom_command(
    ...
    COMMAND ${CMAKE_COMMAND} -D COMMENT_SLUG="\#" -D GLOB_EXT="yaml" -D HEADER_FILE="${MOD_HEADER_TXT_FILE}" -D PACKED_FILE=${MOD_GAME_DIR_TWEAKS_PACKED_FILE} -D SEARCH_FOLDER=${MOD_TWEAKS_SOURCE_DIR} -P ${MOD_CYBERPUNK_CMAKE_MODULE_PATH}/PackFiles.cmake
  )
  list(APPEND MOD_GAME_DIR_FILES ${MOD_GAME_DIR_TWEAKS_PACKED_FILE})

...
set(CYBERPUNK_CMAKE_TOOLS ${CYBERPUNK_CMAKE_MODULE_PATH}/tools)
set(CYBERPUNK_CMAKE_INCLUDE ${CYBERPUNK_CMAKE_MODULE_PATH}/include)
...
set(CYBERPUNK_2077_REDSCRIPT_BACKUP "${CYBERPUNK_2077_GAME_DIR}/r6/cache/final.redscripts")
...
macro(configure_mod)
  ...
  set(MOD_TOOLS_DIR ${CYBERPUNK_CMAKE_TOOLS})

  set(MOD_REQUIREMENTS)
  ...
  set(MOD_VERSION_STR ${GIT_VERSION_STR_FULL})

  message(STATUS "Configuring ${MOD_NAME} ${MOD_VERSION_STR}")

...
if(NOT CMAKE_REDSCRIPT_CREATE_SHARED_MODULE)
    set(CMAKE_REDSCRIPT_CREATE_SHARED_MODULE
        "<CMAKE_REDSCRIPT_COMPILER> compile -s <OBJECT_DIR> <LINK_LIBRARIES> -b \"${CYBERPUNK_2077_REDSCRIPT_BACKUP}\" -o <TARGET>"
    )
endif()
...
if(NOT CMAKE_REDSCRIPT_CREATE_STATIC_LIBRARY)
    set(CMAKE_REDSCRIPT_CREATE_STATIC_LIBRARY
        "<CMAKE_REDSCRIPT_COMPILER> lint -s <OBJECT_DIR> <LINK_LIBRARIES> -b \"${CYBERPUNK_2077_REDSCRIPT_BACKUP}\""
...
macro(add_redscript_dependency DEPENDENCY)
    target_link_libraries(${MOD_SLUG}.redscripts PUBLIC "-s $<JOIN:$<TARGET_OBJECTS:${DEPENDENCY}>, -s >")
    add_dependencies(${MOD_SLUG}.redscripts ${DEPENDENCY})
    target_link_libraries(${MOD_SLUG}.packed.reds PUBLIC "-s $<JOIN:$<TARGET_OBJECTS:${DEPENDENCY}>, -s >")
    add_dependencies(${MOD_SLUG}.packed.reds ${DEPENDENCY})
endmacro()
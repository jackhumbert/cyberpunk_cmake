...
foreach(ARCHIVE_XL ${MOD_ARCHIVE_XLS})
  ...
  list(APPEND MOD_GAME_DIR_ARCHIVE_XLS "${MOD_GAME_DIR_ARCHIVE_XL_DIR}/${ARCHIVE_XL_NAME}")
  add_custom_command(
    OUTPUT ${MOD_GAME_DIR_ARCHIVE_XL_DIR}/${ARCHIVE_XL_NAME}
    DEPENDS ${ARCHIVE_XL}
    COMMAND ${CMAKE_COMMAND} -E copy_if_different
    ${ARCHIVE}
    ${MOD_GAME_DIR_ARCHIVE_XL_DIR}/${ARCHIVE_XL_NAME}
  )
endforeach()
